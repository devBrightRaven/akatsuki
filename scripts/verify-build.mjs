...
assert.match(home, /<body[^>]*id="top"/)
assert.match(home, /class="back-to-top"[^>]*aria-label="Back to top"/)
...
assert.match(style, /\.back-to-top\s*\{[^}]*position:\s*fixed[^}]*width:\s*44px[^}]*height:\s*44px/s)
assert.match(style, /\.back-to-top-icon\s*\{[^}]*width:\s*24px[^}]*height:\s*24px/s)
