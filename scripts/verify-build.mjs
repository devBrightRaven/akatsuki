...
assert.equal((jaHome.match(/class="story-card"/g) || []).length, 3)
...
assert.equal((home.match(/class="story-card"/g) || []).length, 3)
...
assert.equal((home.match(/class="story-card-calligraphy" aria-hidden="true"/g) || []).length, 3)
assert.match(zhHome, />視覺呈現</)
assert.match(zhHome, />文章</)
assert.equal((zhHome.match(/class="story-card"/g) || []).length, 3)
